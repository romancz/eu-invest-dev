...
<div class="slick-mainPage-banner">
<?php print render($content['field_hp_banner']); ?>
</div>
...
<?php print render($content['field_main_section_title']); ?>

<?php print render($content['field_main_content_block']); ?>

<div class="mainpage-middle-banner">
    <?php print $cta_img; ?>
    <?php print $cta_mob_img; ?>
    <span class="middle-banner-text"><?php print $cta_copy; ?></span>
    <a href="<?php print $cta_link_url; ?>" class="middle-banner-link"><?php print $cta_link_title; ?></a>
</div>

<h2 class="project-title">
  <img src="<?php print $img_path;?>/map_pointer.png">
  <?php print t("A selection of relevant projects"); ?>
</h2>
<?php print render($content['field_relevant_projects']); ?>
